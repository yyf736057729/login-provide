...
public class DateUtils  extends org.apache.commons.lang3.time.DateUtils{
    ...
    public static String formatDateBetweenString(Date beginDate, Date endDate){
        ...
        if (org.apache.commons.lang3.StringUtils.isNoneBlank(begin, end)){
            return begin + " ~ " + end;
        }
        return null;
    }
    ...
    public static Date[] parseDateBetweenString(String dateString){
        ...
        if (org.apache.commons.lang3.StringUtils.isNotBlank(dateString)){
            String[] ss = org.apache.commons.lang3.StringUtils.split(dateString, "~");
            if (ss != null && ss.length == 2){
                String begin = org.apache.commons.lang3.StringUtils.trim(ss[0]);
                String end = org.apache.commons.lang3.StringUtils.trim(ss[1]);
                if (org.apache.commons.lang3.StringUtils.isNoneBlank(begin, end)){
