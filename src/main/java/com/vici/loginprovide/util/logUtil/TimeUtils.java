...
public class TimeUtils {
     ...
     */
    public static String subDay(String date, int num) throws ParseException {
     ...
     * @return
     */
    public static boolean dateFormat(Date date) {
        if (date == null) {
            date = new Date();
        }
        ...
        boolean equals = format.equals(dateString);
        return equals;
    }
